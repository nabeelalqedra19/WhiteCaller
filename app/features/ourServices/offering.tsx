...
export default function Offering() {
    const cards = [
        {
            id: 1,
            icon: '/ourServices/icons/productDev.svg',
            tittle: 'Product development',
            description: "level overviews proposition. "
        },
        {
            id: 2,
            icon: '/ourServices/icons/uiux.svg',
            tittle: 'UI/UX designing',
            description: "level overviews proposition. "
        },
        {
            id: 3,
            icon: '/ourServices/icons/dataanalysis.svg',
            tittle: 'Data analysis',
            description: "level overviews proposition. "
        },
        {
            id: 4,
            icon: '/ourServices/icons/contentManag.svg',
    ...
    const cardsList = cards.map((c) => (
        <div key={c.id} className="p-5 border-1 border-[#636363] text-center">
            <Image src={c.icon} alt="Icon" width={60} height={60} className="m-auto"/>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-5">
          <div className="lg:w-100">
            <div className="flex items-center justify-center lg:justify-start gap-1">
              ...
              <div className="font-medium text-sm sm:text-lg">What we’re offering</div>
            </div>
