  ...
  return (
    <div className="font-inter">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/pricePacks/banner.png')",
      ...
      >
        <div className="w-full h-full lg:w-200 py-10 px-5 bg-[#37393FE8] flex justify-center items-center">
          <div className="w-130 flex flex-col justify-start items-between gap-5">
            ...
            <div className="lg:w-140 text-white text-center lg:text-start font-bold text-3xl sm:text-[40px] md:text-[50px] lg:text-[60px] leading-[1.1]">
